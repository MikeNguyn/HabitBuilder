...
extension Habit {
    static let sampleData: [[Habit]] = [[Habit(name: "Drinking Water", plant: Plant(plant: "strawberry", stage: 3), start: Date(), end: Date(), frequency: [false, false, false, false, false, false, false], health: 1.0, importance: 2, empty: false, log: datesForLog, age: 0, stage:1),
                                      ...
                                      Habit(name: "Exercise", plant: Plant(plant: "blueberry", stage: 2), start: Date(), end: Date(), frequency: [false, false, false, false, false, false, false], health: 0.40, importance: 3, empty: false, log: datesForLog, age: 0,stage: 2)],
                                      ...
                                      [Habit(name: "Tell a joke", plant: Plant(plant: "eggplant", stage: 2), start: Date(), end: Date(), frequency: [false, false, false, false, false, false, false], health: 0.82, importance: 2, empty: false, log: datesForLog, age: 0,stage: 3),
